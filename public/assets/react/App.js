...
class ModalTutorial extends React.Component {
	...
	componentDidMount = () => {		
		...
		this.cek();
		// document.getElementById("memorizeButton").click()
	}

	cek = () => {
		this.setState({
			cek: this.props.item.type != 'choice-memo' ? 1 : null
		});
		let cek = this.props.item.type;
				...
				<div class="modal-dialog modal-lg modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="mt-2">
								<div class={`check ${this.props.item.type === 'choice-memo' && isMemorizing !== 1 ? (isMemorizing === 0 ? 'd-none' : '') : 'd-none'}`}>								
									<button id="memorizeButton"  type="button" class="btn btn-lg btn-danger" onClick={this.handleMemorize}>	
										<i class="fa fa-clipboard me-1"></i><strong>Membaca Hafalan</strong>
									</button>
								</div>
							</div>
