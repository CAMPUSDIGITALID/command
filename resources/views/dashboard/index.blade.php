...
<section class="container py-2">
    ...
    @if(Auth::user()->role_id == role('super-admin') || Auth::user()->role_id == role('hrd') || Auth::user()->role_id == role('employee') || 		 Auth::user()->role_id == role('student') || Auth::user()->role_id == role('general'))
    <div class="content">
